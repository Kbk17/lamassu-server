...
const { bitpay, coinbase, itbit, bitstamp, kraken, binanceus, cex, binance, bitfinex, zonda } = ALL
...
const ALL_ACCOUNTS = [
  ...
  { code: 'zonda', display: 'Zonda', class: TICKER, cryptos: zonda.CRYPTO },
  ...
  { code: 'zonda', display: 'Zonda', class: EXCHANGE, cryptos: zonda.CRYPTO },
